  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-extrabold">Welcome! Lets get started</h2>
      ...
      <div className="grid gap-4">
        <Button
          ...
          variant="outline"
          className="width-full h-auto p-6 items-center gap-4 border-2 transition-all duration-200 hover:border-primary hover:bg-primary/5"
        >
